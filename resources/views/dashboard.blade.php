        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="{{ route('my-books.index') }}"
                   class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 hover:shadow-md transition-shadow group">
                    <div class="text-3xl mb-2">✅</div>
                    <p class="font-semibold text-gray-800 group-hover:text-amber-600 transition-colors">Mis leídos</p>
                    <p class="text-gray-500 text-sm mt-1">{{ Auth::user()->readBooks()->count() }} libro(s) · {{ Auth::user()->reviews()->count() }} reseña(s)</p>
                </a>
